...
海龟汤是一个在线横向思维推理游戏平台。主持人抛出一个离奇的「汤面」，玩家只能通过**是/否/部分正确/无关**四种回答来层层剥茧，最终揭开隐藏在水面下的真相——「汤底」。
...
玩家不断提问，主持人只回答「是」「否」「部分正确」「无关」。在一次次的否定和肯定之间，真相逐渐浮出水面。
...
- **AI 辅助** — 可选启用 AI 自动回答、AI 线索提示、游戏进度评估、结局复盘
- **AI 创作助手** — 对话式创作辅助，从零开始构思汤面汤底，支持多方案生成
- **线索板** — AI 自动分析问答记录，生成可视化线索图，帮助玩家梳理推理思路
- **讨论区** — 独立于问答的自由讨论频道，游戏结束后所有人可自由讨论
- **趣味统计** — 最佳侦探、话痨王、南辕北辙王...每局都有颁奖典礼
- **评分系统** — 游戏结束后参与者评分，大厅卡片直观展示
- **暗夜主题** — 神秘紫 + 金色高光，沉浸推理氛围
- **移动优先** — PWA 安装，悬浮按钮，熄屏自动同步
